...
- ✅ `02-PROJEKTY/` + [[00-System/Index]] + `Templates/topic-template.md`
...
- ✅ `OBSIDIAN/[[00-System/Memory/agenda-system]]` (referenční dokument)
- ✅ `OBSIDIAN/00-System/Memory/agenda-skill-cheatsheet.md` (quick reference)
- ✅ `OBSIDIAN/[[00-System/Memory/about-me]]` (drobný update v sekci Slabé stránky)
...
- Před jakoukoli prací jsem přečetl `OBSIDIAN/[[00-System/Memory/about-me]]` a `OBSIDIAN/[[00-System/Memory/anti-ai-writing-tools]]`
